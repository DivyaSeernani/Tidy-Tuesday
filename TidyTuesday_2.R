...
### Spotify songs - Replicating Code by Georgios Karamanis
...
ggplot(spotify) +
  ...
  labs(
    title = toupper("Evolution of valence, liveness, and energy\nof Spotify songs through the years"),
    subtitle = "Tidy Tuesday",
    caption = "Replicating Code by Georgios Karamanis"
  ) +
